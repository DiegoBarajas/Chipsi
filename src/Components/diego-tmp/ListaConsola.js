...
const ListaConsola = () => {
    ...
    useEffect(()=>{
        const getCelulares = async()=>{
            const res = await axios.get(backend()+'/admin/consola');
            setLista(res.data);
        }
        getCelulares();
    }, [lista]);
    ...
    const eliminarCelular = async(id)=>{
        await axios.delete(backend()+'/admin/consola/' + id);
        await axios.delete(backend()+'/admin/proveedor/consola/' + id);
  ...
  return (
    <div className='row'>
        <h1>Consolas</h1>
        <Link className='btn btn-primary' to={'/admin/consola/agregar'}>Agregar Consola</Link>
                ...
                <div className='col-md-4 p-2' key={list._id}>
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            ...
                            <p>sobrecalentamiento: {list.sobrecalentamiento}</p>

                            <p>disco: {list.disco}</p>
                            <p>red: {list.red}</p>
                        ...
                        <div className='card-footer'>
                            ...
                            <Link className='btn btn-warning m-1' to={"/admin/consola/editar/"+list._id}>
                                Editar
                            </Link>
                        </div>
