...
const AgregarTableta = () => {
    ...
    const guardarDatos = async(e)=>{
        ...
        if(document.getElementById('marca').value === '---Elige Una Opcion---'){
            ...
            const res = await axios.post(backend()+'/admin/tableta', data);
            ...
            await axios.post(backend()+'/admin/proveedor/tableta', proveedorData);
    ...
    return (
        <div>
            <h1 className='text-center mb-3'>Agregar tableta</h1>
