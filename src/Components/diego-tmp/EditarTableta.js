...
const EditarTableta = () => {
    ...
    useEffect(()=>{
        const getcelular = async()=>{
            const res = await axios.get(backend()+'/admin/tableta/'+id);
            setcelular(res.data);
        }

        const getProveedor = async()=>{
            const res = await axios.get(backend()+'/admin/proveedor/tableta/'+id)
    ...
    const actualizarDatos = async(e)=>{
        ...
        await axios.put(backend()+'/admin/tableta/'+id, data);
        await axios.put(backend()+'/admin/proveedor/tableta/'+id, proveedorData);
    ...
    return (
        <div>
            <h1 className='text-center mb-3'>Actualizar tableta</h1>
            <Link className='btn btn-primary' to={'/admin/tableta/lista'}>Lista tableta</Link>
